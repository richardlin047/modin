...
class PandasOnMPIFramePartition(BaseFramePartition):
    ...
    def apply(self, func, **kwargs):
        ...
        future = _get_global_executor().submit(
            apply_list_of_funcs, call_queue, self.future
        )
        return PandasOnMPIFramePartition(future)

    def add_to_apply_calls(self, func, **kwargs):
        return PandasOnMPIFramePartition(
    ...
    def put(cls, obj):
        ...
        def f(x):
            return x
        return cls(_get_global_executor().submit(f, obj))
