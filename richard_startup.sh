...
sudo -u "$USERNAME" -i /bin/bash -l -c "conda activate $CONDA_ENV; pip install $WHEEL; git clone https://github.com/richardlin047/modin.git; cd modin; git pull origin partition_benchmark; python scaleup_dataframe.py""
